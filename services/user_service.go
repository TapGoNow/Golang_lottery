...
func (u *userService) GetAll(page, size int) []models.LtUser {
	return u.dao.GetAll(page, size)
}

func (u *userService) CountAll() int {
	return u.dao.CountAll()
}

func (u *userService) Get(id int) *models.LtUser {
	return u.dao.Get(id)
}
...
func (u *userService) updateByCache(data *models.LtUser, columns []string) {
	if data == nil || data.Id <= 0 {
		return
	}
	// 集群模式，redis缓存
